...
if __name__ == "__main__":
    ...
    parser.add_argument('--index', type=str, default='nycbike') #表示数据集是哪个，BJTAXI,NYCBIKE,NYCTAXI
    ...
    parser.add_argument('--epoch', type=int, default=500) #24小时训练完
    ...
    if args.pretrained_model_path !=False:
        ...
        model.model.load_state_dict(dic,strict=True)   #加载最佳模型参数
        model.model.eval()
        with torch.no_grad():
